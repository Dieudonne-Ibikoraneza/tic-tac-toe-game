...
namespace MetaMask
{
    ...
    public class MetaMaskWallet : IDisposable
    {
        ...
        /// <summary>The sokcet connection used in the user wallet session.</summary>
        ...
        private Dictionary<string, MetaMaskSubmittedRequest> submittedRequests = new Dictionary<string, MetaMaskSubmittedRequest>();
        ...
        protected void OnMessageReceived(string response)
        {
            ...
            else
            {
                ...
                var data = decryptedMessage.GetProperty("data");
        ...
        public void Connect()
        {
            ...
            string url = MetaMaskAppLinkUrl + "/connect?channelId=" + Uri.EscapeDataString(channelId) + "&pubkey=" + Uri.EscapeDataString(this.session.PublicKey);
            try
            {
